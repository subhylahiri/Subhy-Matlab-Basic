function [ph, slh, edh] = slider(parent, data, varname, position, minval, maxval)
...
if iscell(varname)
    [ph, slh, edh] = mygui.make.grid('editbox', {parent, data}, varnames,...
...
uicontrol(ph, 'Style', 'pushbutton', data.opts_btn{:},...
