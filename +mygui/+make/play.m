function [slh, pbh, edh] = play(parent, data)
...
%slider
slh = uicontrol(parent, 'Style', 'slider', data.opts_btn{:},...
...
edh = uicontrol(parent, 'Style', 'edit', data.opts_btn{:},...
...
%slider labels
uicontrol(parent, 'Style', 'text', data.opts_btn{:},...
    'String', data.firstfr,...
